...
Page {
    id: mainPage
    tools: mainTools
    property alias showSettings: accountsList.editSettingsMode
    ...
    onAccountClicked: {
        pageStack.push(Qt.resolvedUrl((showSettings ? "SettingsListPage.qml" : "FoldersListPage.qml")), {accountId: id})
    }
}
